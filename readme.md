...
### Clears the Barn Markers

`/function ai_farm:barn_marker/clear_all`
`/function ai_farm:barn_marker/clear_nearest`

### Gives Barn Marker Spawn Egg

`/function ai_farm:barn_marker/give`

### Removes First Meeting Memory for all mobs

`/tag @e remove aiSpokenTo`

'@e' can be replaced with anything else
...
If you are Opped on the server, otherwise the RCon will overwhelm you
